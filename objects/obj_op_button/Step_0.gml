...
gap_y   = 180;      // separación hacia el botón de volver

// Fila: [Vueltas][ - ][ valor ][ + ]
label_w = 150;  label_h = 60;   // rectángulo "Vueltas"
sq_w    = 60;   sq_h    = 60;   // cuadrados +/- 
val_w   = 70;   val_h   = 60;   // recuadro del valor
gap_x   = 20;                 // espacio horizontal entre elementos
